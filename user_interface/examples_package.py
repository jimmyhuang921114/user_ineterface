...
class PracticalExamples:
    ...
    def example_read_detailed_medicine(self, medicine_name: str = ""):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"Medicine: {medicine_info.get('', {}).get('', 'Unknown')}")
                print(f"Manufacturer: {medicine_info.get('', {}).get('', 'Unknown')}")
                print(f"Dosage: {medicine_info.get('', {}).get('', 'Unknown')}")
                print(f"Indications: {medicine_info.get('', 'Unknown')[:100]}...")
    ...
    def example_create_detailed_medicine(self):
        ...
        detailed_medicine = {
            ...
            "medicine_data": {
                ...
                "": {
                    "1": f"EX{datetime.now().strftime('%Y%m')}",
                    "2": f"TEST{datetime.now().strftime('%d%H')}"
                },
                "": "",
                "": "",
                "": "",
    ...
    def example_create_medical_record(self, patient_id: int = None):
        ...
        new_record = {
            ...
            "diagnosis": "",
            "prescribed_medicines": [" 10mg", "C 500mg"],
            "dosage_instructions": "C",
            "doctor_notes": ""
        }
        ...
        if basic_medicine:
            ...
            detailed_info = {
                ...
                "medicine_data": {
                    ...
                    "": {
                        "1": f"DEMO{datetime.now().strftime('%Y')}",
                        "2": f"TEST{datetime.now().strftime('%m%d')}"
                    },
                    "": "",
                    "": "",
                    "": ""
