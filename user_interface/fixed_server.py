...
if __name__ == "__main__":
    ...
    print("   👨‍⚕️ 醫生工作站: http://localhost:8000/doctor.html")
    print("   📋 處方籤管理: http://localhost:8000/Prescription.html")
    print("   💊 藥物管理: http://localhost:8000/Medicine.html")
    print("   🔧 整合管理: http://localhost:8000/integrated_medicine_management.html")
    print("   🤖 ROS2測試: http://localhost:8000/ros2_test.html")
    print()
    print("🔗 API端點:")
